...
public class ComputeTaxForAllFilers {
    public static void main(String[] args) {
        ...
        if (status < 4) {
            ...
            } else if (status == 1) //married filing jointly or qualified widow(er)
            {
                if (income <= 16700)
                    tax = income * 0.10;
                    ...
                    tax = 8350 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (income - 208850) * 0.33;
                else
                    tax = 8350 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (372950 - 208850) * 0.33 + (income - 372950) * 0.35;
