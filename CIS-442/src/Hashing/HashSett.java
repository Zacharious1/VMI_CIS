...
public class HashSett<AnyType> {
    ...
    public void rehash() {
        ...
        for (int i = 0; i < oldLists.length; i++) {
            List<AnyType> oldList = oldLists[i];
            for (int j = 0; j < oldList.size(); j++) {
                AnyType item = oldList.get(j);
                insert(item);
            }
    ...
    public static void main(String[] args) {
        HashSett<Integer> a = new HashSett<Integer>(11);
        a.insert(12);
        a.insert(23);
        a.insert(34);
        a.insert(11);
